...
Let us consider the event of throwing a pair of dice for obtaining a doublet \brak{Success}. Let us represent the outcomes of this event by the Bernoulli random variable X such that $X \in \cbrak{0, 1}$ \newline
\begin{table}[h]
    \centering

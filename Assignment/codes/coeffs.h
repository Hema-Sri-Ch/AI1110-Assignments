...
//Defining the function to calculate the mean of x^2
...
//End function for calculating the mean of x^2

//Defining functioin for calculating Variance
double variance(char *str){
	double c = 0.0;
	c = mean2(str) - (mean(str)*mean(str));
	return c;
}
//End function for calculation Variance

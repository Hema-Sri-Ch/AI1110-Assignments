...
\hhline{|-|-~}
	...
	{\gnumericPB{\centering}\gnumbox{\textbf{Vehicle}}}
...
\hhline{|--|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{Two-wheeler}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|--|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{Three-wheeler}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|--|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{Four-wheeler}}
	&\multicolumn{1}{p{\gnumericColB}|}%
